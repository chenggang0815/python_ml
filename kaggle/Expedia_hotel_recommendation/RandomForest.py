...
if os.path.exists('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output/srch_dest_hc_hm_agg.csv'):
    agg1 = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output/srch_dest_hc_hm_agg.csv')
    print('if')
else:
    print('else')
    reader = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/train.csv', parse_dates=['date_time', 'srch_ci', 'srch_co'], chunksize=200000)
    pieces = [
    ...
    agg1.to_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output/srch_dest_hc_hm_agg.csv', index=False)
    del agg
...
destinations = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/destinations.csv')
submission = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/sample_submission.csv')
...
reader = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/train.csv',
                        parse_dates=['date_time', 'srch_ci', 'srch_co'], chunksize=chunksize)
for chunk in reader:
    try:
        ...
        print('%d rows fit completed' % count)
...
reader = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/test.csv',
                         parse_dates=['date_time', 'srch_ci', 'srch_co'], chunksize=chunksize)
for chunk in reader:
    chunk = pd.merge(chunk, destinations, how='left', on='srch_destination_id')
    chunk = pd.merge(chunk, agg1, how='left', on=['srch_destination_id', 'hotel_country', 'hotel_market'])
    ...
    count = count + chunksize
    print('%d rows predict completed' % count)

del clf
del agg1
print('writing current probabilities to file')
if os.path.exists('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output/probs/allpreds.h5'):
    with h5py.File('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output/probs/allpreds.h5',
                    'r+') as hf:
...
sub.to_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output/pred_sub.csv', index=False)
