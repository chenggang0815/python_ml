...
if os.path.exists('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output_xgb/srch_dest_hc_hm_agg.csv'):
    agg1 = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output_xgb/srch_dest_hc_hm_agg.csv')
else:
    ...
    agg1.to_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output_xgb/srch_dest_hc_hm_agg.csv', index=False)
    del agg
...
train = pd.read_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/train.csv',
                    parse_dates=['date_time', 'srch_ci', 'srch_co'], skiprows=skip, nrows=tchunksize)
...
clf.fit(X_train, y_train, early_stopping_rounds=50, eval_metric=map5eval,
...
del agg1
if os.path.exists(
        'D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output_xgb/probs/allpreds_xgb.h5'):
    with h5py.File(
            'D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output_xgb/probs/allpreds_xgb.h5',
            'r+') as hf:
...
sub.to_csv('D:/Users/chenggang/Desktop/Lesson13_RecommendationSystemCompetition/output_xgb/pred_sub.csv', index=False)
